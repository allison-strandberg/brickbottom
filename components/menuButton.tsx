...
export default function MenuButton({ menuOpen, setMenuOpen }: MenuButtonProps) {
  return (
    <div className="flex justify-center absolute top-0 right-0 lg:relative h-full lg:h-auto">
      <button
      ...
      >
        ...
        <span className="px-2 hidden lg:block">Menu</span>
      </button>
    </div>
  );
}
